...
with st.form("prediction_form"):
    sector = st.selectbox("sector",["None", "Biofuels", "Chemical logistics", "Chemical production", 
    ...
    sector = "nan" if sector.strip() == "None" else sector
    cod_before = st.number_input("COD Before Treatment g/L", min_value=0.0, step=0.0001, format="%.6f")
    
    chem1 = st.selectbox("Chemical 1", ["None", "HClO", "FeCl3", "FerSol", "Poly", "NaOH", "KFerSol", "PAC", "Iron Sulphate",
    ...
    chem1 = "nan" if chem1.strip() == "None" else chem1
    chem1_dose = st.number_input("Chemical 1 Dose ml/L", min_value=0.0, step=0.0001, format="%.6f")

    chem2 = st.selectbox("Chemical 2", ["None", "HClO", "FeCl3", "FerSol", "Poly", "NaOH", "KFerSol", "PAC", "Iron Sulphate",
                                        "CaOH", "H2O2", "HNO3", "KH2PO4", "VTA", "VAT", "CTAB", "APG", "M40", "Al2(SO4)3",
                                        "Al(SO4)3", "HCl", "Fe2(SO4)3", "NaSi", "CH3COOH", "FeSO4", "NaClO", "CaO", "RP34",
                                        "SDS", "Na-EDTA", "Combiphos L7", "HB-5265", "Ferric 40%", "H2SO4"])
    chem2 = "nan" if chem2.strip() == "None" else chem2
    chem2_dose = st.number_input("Chemical 2 Dose ml/L", min_value=0.0, step=0.0001, format="%.6f")

    chem3 = st.selectbox("Chemical 3", ["None", "HClO", "FeCl3", "FerSol", "Poly", "NaOH", "KFerSol", "PAC", "Iron Sulphate",
                                        "CaOH", "H2O2", "HNO3", "KH2PO4", "VTA", "VAT", "CTAB", "APG", "M40", "Al2(SO4)3",
                                        "Al(SO4)3", "HCl", "Fe2(SO4)3", "NaSi", "CH3COOH", "FeSO4", "NaClO", "CaO", "RP34",
                                        "SDS", "Na-EDTA", "Combiphos L7", "HB-5265", "Ferric 40%", "H2SO4"])
    chem3 = "nan" if chem3.strip() == "None" else chem3
    chem3_dose = st.number_input("Chemical 3 Dose ml/L", min_value=0.0, step=0.0001, format="%.6f")

    chem4 = st.selectbox("Chemical 4", ["None", "HClO", "FeCl3", "FerSol", "Poly", "NaOH", "KFerSol", "PAC", "Iron Sulphate",
                                        "CaOH", "H2O2", "HNO3", "KH2PO4", "VTA", "VAT", "CTAB", "APG", "M40", "Al2(SO4)3",
                                        "Al(SO4)3", "HCl", "Fe2(SO4)3", "NaSi", "CH3COOH", "FeSO4", "NaClO", "CaO", "RP34",
                                        "SDS", "Na-EDTA", "Combiphos L7", "HB-5265", "Ferric 40%", "H2SO4"])
    chem4 = "nan" if chem4.strip() == "None" else chem4
    chem4_dose = st.number_input("Chemical 4 Dose ml/L", min_value=0.0, step=0.0001, format="%.6f")

    chem5 = st.selectbox("Chemical 5", ["None", "HClO", "FeCl3", "FerSol", "Poly", "NaOH", "KFerSol", "PAC", "Iron Sulphate",
                                        "CaOH", "H2O2", "HNO3", "KH2PO4", "VTA", "VAT", "CTAB", "APG", "M40", "Al2(SO4)3",
                                        "Al(SO4)3", "HCl", "Fe2(SO4)3", "NaSi", "CH3COOH", "FeSO4", "NaClO", "CaO", "RP34",
                                        "SDS", "Na-EDTA", "Combiphos L7", "HB-5265", "Ferric 40%", "H2SO4"])
    chem5 = "nan" if chem5.strip() == "None" else chem5
    chem5_dose = st.number_input("Chemical 5 Dose ml/L", min_value=0.0, step=0.0001, format="%.6f")

    chem6 = st.selectbox("Chemical 6", ["None", "HClO", "FeCl3", "FerSol", "Poly", "NaOH", "KFerSol", "PAC", "Iron Sulphate",
                                        "CaOH", "H2O2", "HNO3", "KH2PO4", "VTA", "VAT", "CTAB", "APG", "M40", "Al2(SO4)3",
                                        "Al(SO4)3", "HCl", "Fe2(SO4)3", "NaSi", "CH3COOH", "FeSO4", "NaClO", "CaO", "RP34",
                                        "SDS", "Na-EDTA", "Combiphos L7", "HB-5265", "Ferric 40%", "H2SO4"])
    chem6 = "nan" if chem6.strip() == "None" else chem6
